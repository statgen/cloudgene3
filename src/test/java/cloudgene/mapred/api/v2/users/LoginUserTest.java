...
public class LoginUserTest {
	...
	public void setUp() {
		...
		testUser1.setFullName("Login 1");
		testUser1.setMail("user1@login.user.test");
		...
		testUser2.setFullName("Login 2");
		testUser2.setMail("user2@login.user.test");
		...
		testUser3.setFullName("Login 3");
		testUser3.setMail("lockeduser@login.user.test");
	...
	public void testWrongPasswordAndLocking() {
		...
		for (int i = 1; i < 10; i++) {
			...
			RestAssured
					...
					.then()
					.statusCode(200)
					.body("username", equalTo("lockeduser"))
					.body("access_token", not(emptyString()));
